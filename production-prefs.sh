...
# sudo scutil --set ComputerName "%UserID%"
# sudo scutil --set HostName "%UserID%"
# sudo scutil --set LocalHostName "%UserID%"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "%UserID%"
...
defaults_enable com.apple.dock magnification
# Set dock magnificated icon size.
defaults_set_int com.apple.dock largesize 72

killall Dock

# Use dark menu bar and dock.
# defaults_set NSGlobalDomain AppleInterfaceStyle Dark
